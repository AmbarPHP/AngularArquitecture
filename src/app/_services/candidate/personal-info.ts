...
@Injectable()
export class CandidatePersonalInfoService {
    ...
    resume(formData, pk) {
        ...
        return this.http.post(Constants.API_ENDPOINT + 'profiles-attachment/file/' + pk + '/', formData, this.imagejwt()).map(res => res.json())
    }
